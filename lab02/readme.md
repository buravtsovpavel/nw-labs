...
* Стоимость Root Path Cost коммутаторов S2 и S3 была одинаковой и Designated порт был определен на основе меньшего BID в сегменте(BID в сегменте был меньше у S2, соответственно DT был выбран на нём). После того как изменили стоимость порта e0/0 появилась разница в Root Path Cost и DT был выбран на её основании.  
