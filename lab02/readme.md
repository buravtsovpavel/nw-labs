...
* Если при определении корневых портов стоимость линков до корневого коммутатора (Root Path Cost) и Bridge ID коммутаторов до корневого коммутатора совпадает (например, как в нашем случае, когда между двумя коммутаторами два и более линка), то тогда корневой порт выбирается на основе меньшего Port ID соседа (lowest neighbor port ID). В нашем случае e0/1 на S1 - сооветственно e0/1 root на S2 и аналогично e0/0 root на S3.
