...
Сначала пропишем статические маршруты, что бы можно было проверять связанность и политику маршрутизации до Лабытнанги
...
! маршурт до loopback Лабытнанги
ip route 10.7.0.1 255.255.255.255 200.50.0.38 name to_labitnangi_loopback
```
...
! маршурт до loopback Лабытнанги
ip route 10.7.0.1 255.255.255.255 10.0.20.13 name to_labitnangi_loopback
```
