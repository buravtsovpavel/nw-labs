...
Включить EIGRP на всех интерфейсах можно командой: (все коннектед сети попадут в анонс, а на интерфейсы подсети которых не следует анонсировать можно включить passive-interface):
