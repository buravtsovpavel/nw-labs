...
Сделаем ip-связность по loopback'ам между офисами Москва и С.-Петербург, а так же по ip внешних подсетей, на которых установлены BGP-соседства с промежуточными AS.
...
Настраиваем аналргичным образом eBGP между остальными AS, на R15 и R18 анонсировав loopback'и
